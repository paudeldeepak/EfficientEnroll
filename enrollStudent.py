...
if __name__ == "__main__":
    ...
    # StudentNode Test
    #------------------------
    item = StudentNode("123456", "SCI", "Mary", "Soleiman")
    item1 = StudentNode("223456", "ENG", "Jane", "Osborne")
    item2 = StudentNode("323456", "BUS", "Faruk", "Hosney")

    # test getID
    print("ID:", item.getID())

    # test getFac
    print("Fac:", item.getFac())

    # test getFirstName
    print("First:", item.getFirstName())

    # test getLastName
    print("Last:", item.getLastName())

    # test getNext
    print("Next:", item.getNext())

    # test getPrev
    print("Prev:", item.getPrev())
    ...
    # test getFirstName of next
    print("Next First:", item.getNext().getFirstName())

    # test setPerv()
    item.setPrev(item2)

    # test getPrev
    print("Previous:", item.getPrev())

    # test getFirstName of previous
    print("Previous First:", item.getPrev().getFirstName())

    #------------------------
    # EnrollTable Test
    #------------------------
    item = StudentNode("123456", "SCI", "first", "last")
    item1 = StudentNode("223456", "ENG", "first", "last")
    item2 = StudentNode("323456", "BUS", "first", "last")
    item3 = StudentNode("423456", "ART", "first", "last")
    item4 = StudentNode("523456", "EDU", "first", "last")
    item5 = StudentNode("623456", "SCI", "first", "last")
    item6 = StudentNode("723456", "BUS", "first", "last")
    item7 = StudentNode("823456", "SCI", "first", "last") 
    table = EnrollTable(51)
    table2 = EnrollTable(51)

    # test isEmpty
    print("Empty:",table.isEmpty())
    ...
    item8 = StudentNode("129051", "BUS", "first", "last")
    item9 = StudentNode("188451", "SCI", "first", "last") 
    table2.insert(item8)
    table2.insert(item9)
    ...
    # test isEnrolled
    print("Enrolled:",table2.isEnrolled("188451"))
    print("Enrolled:",table2.isEnrolled("523456"))

    # test remove
    table2.remove("188451")
    ...
    # enque in priority order
    queue.enqueue(item)
    queue.enqueue(item1)
    queue.enqueue(item2)
    queue.enqueue(item3)
    queue.enqueue(item4)
    print("After enqueue in order:")
    # print queue
    print(queue)
    # check size 
    print("Size:",queue.size())
    ...
    print("Empty",queue.isEmpty())
    # dequeue
    print("ID dequeue node:",queue.dequeue().getID())
    ...
    # enque in different priority order
    print("Random Order:")
    queue2.enqueue(item7)
    queue2.enqueue(item2)
    queue2.enqueue(item)
    queue2.enqueue(item5)
    queue2.enqueue(item6)
    queue2.enqueue(item4)
    queue2.enqueue(item3)
    queue2.enqueue(item1)
    # print queue
    print(queue2)
    print("Size:",queue2.size())
    # check if empty
    print("Empty",queue2.isEmpty())
    # dequeue
    print("ID dequeue node:",queue2.dequeue().getID())
    # print queue after dequeue
    print(queue2)
    # check size 
    print("Size:",queue2.size())